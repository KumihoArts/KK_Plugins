...
namespace MaterialEditorAPI
{
    ...
    public partial class MaterialEditorPluginBase : BaseUnityPlugin
    {
        ...
        /// <summary>Available font options for the Material Editor UI</summary>
        public enum MEFont
        {
            /// <summary>JetBrains Mono font</summary>
            JetBrainsMono,
            /// <summary>Cascadia Mono font</summary>
            CascadiaMono,
            /// <summary>Noto Sans font</summary>
            NotoSans,
            /// <summary>Arial (Unity built-in)</summary>
            Arial
        }
        /// <summary>

...
namespace MaterialEditorAPI
{
    internal sealed class ItemInfo
    {
        ...
        /// <summary>Live getter — fetches the texture directly from the material so the preview always reflects the current state.</summary>
        public Func<Texture> TexturePreviewLive { get; set; }
